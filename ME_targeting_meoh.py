...
def main():
    ...
    ### C1 uptake constraints ###
    gur = cobra_model.reactions.EX_glc__D_e.lower_bound
    cobra_model.reactions.EX_glc__D_e.bounds = (0, 0)
    cobra_model.reactions.EX_meoh_e.lower_bound = gur * 6
    ...
    if method == 'moma':
        run_MOMA_targeting(output_dir, cobra_model, bio_rxn, 
                           target_reaction, carbon_reaction, constraints,
        ...
        run_MVSEOF_targeting(output_dir, cobra_model, bio_rxn, 
                             target_reaction, cpu_num)
    elif method == 'fseof':
        run_FSEOF_targeting(output_dir, cobra_model, bio_rxn, 
                            target_reaction)
    elif method == 'fra':
        run_FRA_targeting(output_dir, cobra_model, bio_rxn, 
                          target_reaction, cpu_num)
    else:
